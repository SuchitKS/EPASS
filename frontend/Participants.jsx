...
export default function Participants() {
  ...
  async function fetchParticipantEvents() {
    try {
      const response = await fetch(`${API_BASE}/api/participant/events`, {
        credentials: 'include',
  ...
  useEffect(() => {
    let mounted = true;
    setLoading(true);
    fetchParticipantEvents().then(events => {
      if (mounted) {
  ...
  function handleParticipateOtherEvent() {
      ...
      <section className="hero-section">
        <div className="container">
          ...
          <div className="button-container">
            <button onClick={handleParticipateOtherEvent}>Participate in other Event</button>
          </div>
        </div>
      </section>
      {message && (
