...
const Volunteers = () => {
  ...
  useEffect(() => {
    const fetchVolunteerEvents = async () => {
      try {
        setLoading(true);
        const { data, error: apiError } = await api.getVolunteerEvents();
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Volunteer Work</h1>
        <p className="text-gray-600">View and manage your volunteer activities</p>
      </div>

      {/* Ongoing Volunteer Work */}
      {events.ongoing.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-orange-600">Ongoing Volunteer Work</h2>
      ...
      {events.upcoming.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-green-600">Upcoming Volunteer Work</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {events.completed.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-gray-600">Completed Volunteer Work</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {events.ongoing.length === 0 && events.upcoming.length === 0 && events.completed.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">You haven't signed up for any volunteer work yet.</p>
          <button
...
const VolunteerEventCard = ({ event, onView, onViewTasks, status }) => {
