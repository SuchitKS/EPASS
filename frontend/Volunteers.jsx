...
import './volunteers.css'; // Assuming this is in the same folder
...
function Volunteers() {
  ...
  const handleEventButtonClick = (eventId) => { // Removed eventType param as it's not needed for navigation
    console.log(`Button clicked for event ${eventId}`);
    navigate(`/ticket2?eventId=${eventId}`); // Use navigate instead of window.location for SPA consistency, removed .html
  };
    ...
    return eventList.map((event) => (
      <div key={event.eid} className="event-item">
        ...
        <div className="event-actions">
          <button className="event-btn" onClick={() => handleEventButtonClick(event.eid)}>
          ...
          <div className="card-grid">
            <div className="card" id="ongoing-card">
              ...
              <div className="card__content">
                ...
                <div className="card__details">{renderEventList(events.ongoing, 'ongoing')}</div>
              </div>
            </div>
            <div className="card" id="completed-card">
              ...
              <div className="card__content">
                ...
                <div className="card__details">{renderEventList(events.completed, 'completed')}</div>
              </div>
            </div>
            <div className="card" id="upcoming-card">
              ...
              <div className="card__content">
                ...
                <div className="card__details">{renderEventList(events.upcoming, 'upcoming')}</div>
              </div>
            </div>
          </div>
