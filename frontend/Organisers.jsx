...
export default function Organisers() {
  ...
  async function fetchOrganiserEvents() {
    try {
      const response = await fetch(`${API_BASE}/api/organiser/events`, {
        credentials: 'include',
  ...
  useEffect(() => {
    let mounted = true;
    setLoading(true);
    fetchOrganiserEvents().then(events => {
      if (mounted) {
  ...
  function handleOrganiseNewEvent() {
      ...
      <section className="hero-section">
        <div className="container">
          ...
          <div className="button-container">
            <button onClick={handleOrganiseNewEvent}>Organise New Event</button>
          </div>
        </div>
      </section>
      {message && (
